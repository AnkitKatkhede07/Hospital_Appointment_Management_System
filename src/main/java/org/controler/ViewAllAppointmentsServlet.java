...
/**
 * Servlet implementation class ViewAllAppointmentsServlet
 */
...
public class ViewAllAppointmentsServlet extends HttpServlet {
     ...
     */
    public ViewAllAppointmentsServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<title>All Appointments</title>");
		...
		out.println("<h1 class='title'>All <span>Appointments</span></h1>");

		out.println("<p class='sub'>Manage patient appointments and status updates.</p>");
		...
		for (Appointment a : list) {
		    ...
		    out.println("<a class='approve-btn' href='updateAppointmentStatus?id="
		            + a.getId()
		            + "&status=Approved'>Approve</a>");

		    out.println("<a class='reject-btn' href='updateAppointmentStatus?id="
		            + a.getId()
